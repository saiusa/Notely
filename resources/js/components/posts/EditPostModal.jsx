...
import '../../../sass/components/_post_composer.scss';
...
export default function EditPostModal({ 
    ...
    const handleSavePost = async () => {
        ...
        try {
            ...
            if (postType === 'text' && title && title.trim() !== '' && title !== 'null') {
            ...
            // Send update request via POST with method spoofing (FormData + _method: PUT)
            ...
            // Trigger callback to update parent component's state
            if (onPostUpdated) {
    ...
    return (
        <div className="composer-modal__wrapper composer-modal__wrapper--edit-fixed">
            <section className="composer-modal__section composer-modal__section--edit-modal">
                ...
                <div className="composer-modal__header" style={{ marginBottom: '1.5rem' }}>
                    <div className="composer-modal__content">
                        ...
                        {postType === 'quote' && (
                            <textarea
                                ...
                                className="composer-modal__textarea composer-modal__textarea--quote-input"
                        ...
                        {postType === 'image' && (
                            <>
                                ...
                                {imagePreview ? (
                                    <div className="composer-modal__image-container">
                                        <img
                                            src={imagePreview}
                                            alt="Post image"
                                            className="composer-modal__image"
                                        />
                                        <button
                                            type="button"
                                            onClick={handleImageUploadClick}
                                            disabled={posting}
                                            className="composer-modal__image-replace-btn"
                                            title="Replace image"
                                        >
                                            <span className="material-symbols-outlined">
                                                add_a_photo
                                        ...
                                        {newImage && (
                                            <button
                                                ...
                                                disabled={posting}
                                                className="composer-modal__image-revert-btn"
                ...
                {/* Error Message */}
                {error && (
                    <div className="composer-modal__error">
                        {error}
                    </div>
                )}
                ...
                <div className="composer-modal__actions">
                    ...
                    <button
                        ...
                        className="composer-modal__save-btn"
                        disabled={posting}
                    >
